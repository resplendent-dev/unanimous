...
class PluginTestCase(unittest.TestCase):
    ...
    def dedent(content):
        ...
        When normalizing indentation of text, you often leave a new line at
    ...
    @staticmethod
    def assert_spell_required(running):
        ...
        if required not in ("both", "any", "aspell", "hunspell"):
            raise RuntimeError(
                "Invalid value of '{}' in 'TOX_SPELL_REQUIRE'".format(required)
            )
    ...
    def assert_spellcheck(self, config_file, expected, verbose=4):
        """Spell check."""
